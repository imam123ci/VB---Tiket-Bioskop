Public Class FormPesan
    ...
    End Sub
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles NamaSirkus.SelectedIndexChanged
    ...
    Private Sub JenisTiket_Click(sender As Object, e As EventArgs) Handles TotalHarga.Click
        If Module1.JenisTiket = "VIP" Then
            Module1.TotalHarga = Val(2000000) * Module1.BanyakTiket
        End If
        If Module1.JenisTiket = "CAT1" Then
